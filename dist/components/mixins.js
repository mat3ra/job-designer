export const StatePropsCompareOnUpdateForJobMIxin = (superclass) => class extends superclass {
    shouldComponentUpdateForJob(nextProps, nextState) {
        ...
        const [nextProps_, thisProps_, nextState_, thisState_] = [
            ...
            nextState,
            this.state,
        ].map(JSON.stringify, (key, value) => value && typeof value.toJSON === "function" && key !== ""
