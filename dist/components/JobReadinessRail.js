 ...
 */
export default function JobReadinessRail({ steps, activeStepId, onSelect, children, }) {
    ...
    return (_jsxs(Stack, { component: "nav", "aria-label": "Job steps", id: "job-readiness-rail", sx: {
            ...
            gap: 0.25,
                ...
                return (_jsxs(ButtonBase, { ref: (node) => {
