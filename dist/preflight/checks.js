...
export const checkInputs = async ({ job, materials = [], isUsingMaterials = true, }) => {
    var _a, _b, _c;
    if (!isUsingMaterials) {
 ...
 */
export const checkWorkflowRenders = async ({ job }) => {
    var _a, _b;
    const subworkflows = (_b = (_a = job.workflow) === null || _a === void 0 ? void 0 : _a.subworkflows) !== null && _b !== void 0 ? _b : [];
 ...
 */
export const checkComputeLimits = async ({ job, clusterMetadata = [] }) => {
    ...
    const resources = `${(_b = compute === null || compute === void 0 ? void 0 : compute.nodes) !== null && _b !== void 0 ? _b : "?"}×${(_c = compute === null || compute === void 0 ? void 0 : compute.ppn) !== null && _c !== void 0 ? _c : "?"}`;
    const limits = (_d = findClusterMetadata(compute, clusterMetadata)) === null || _d === void 0 ? void 0 : _d.limits;
    if (!limits) {
        return {
            id: "compute",
            label: "Compute within limits",
